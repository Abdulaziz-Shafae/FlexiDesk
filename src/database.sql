...
-- Drop all existing tables (in order due to foreign key constraints)
DROP TABLE IF EXISTS Reports, Alerts, Notifications, user_projects, Tasks, Projects, Users, MetaValues;
...
('Website Redesign', 'Modern UI overhaul of company site', '2024-04-01', '2024-06-30'),
('Mobile App Launch', 'Cross-platform mobile launch', '2024-05-01', '2024-08-01'),
('Internal CRM System', 'Rebuild CRM system for sales team', '2024-06-01', '2024-09-01');
...
-- Project 1
(1, 'Design homepage mockup', 'Figma prototype', '2024-04-02', '2024-04-10', 'high', 1, NULL, 'In Progress'),
(1, 'SEO audit', 'Analyze SEO', '2024-04-11', '2024-04-20', 'medium-low', 2, NULL, 'Pending'),
(1, 'Bug fixes round 1', 'Fix styling bugs', '2024-04-21', '2024-05-01', 'medium', 3, NULL, 'Completed'),
-- Project 2
(2, 'Create splash screen', 'App launch screen', '2024-05-02', '2024-05-15', 'medium', 1, NULL, 'Pending'),
(2, 'Set up backend auth', 'Firebase & Node setup', '2024-05-10', '2024-05-20', 'critical', 2, NULL, 'In Progress'),
(2, 'Push notification test', 'FCM integration', '2024-05-22', '2024-05-30', 'medium-low', 3, NULL, 'Pending'),
-- Project 3
(3, 'Define user roles', 'Admin, Sales, Viewers', '2024-06-02', '2024-06-10', 'high', 4, NULL, 'Completed'),
(3, 'Dashboard wireframe', 'Initial wireframe UX', '2024-06-12', '2024-06-20', 'medium', 5, NULL, 'In Progress');
